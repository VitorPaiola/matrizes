...
Para explorar mais sobre manipulação de **matrizes**, estruturas bidimensionais e operações matemáticas em Java, confira meu artigo no [DEV.to](https://dev.to/vitorpaiola/lista-de-exercicios-basicos-em-java-part-9-21fe) 🚀
