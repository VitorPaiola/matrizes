...
public class MatrizDiagonalV2 {
    ...
    public static int tamanhoMatriz(Scanner entrada) {
        return solicitarValor("Digite o tamanho da matriz quadrada (N): ", entrada, 1);
    }

    public static void criarMatriz(int[][] matriz, Scanner entrada) {
        for (int i = 0; i < matriz.length; i++) {
            for (int j = 0; j < matriz[i].length; j++) {
                matriz[i][j] = solicitarValor("Digite o valor para a posicao [" + i + "][" + j + "]: ", entrada, 0);
            }
        }
    }

    public static int solicitarValor(String mensagem, Scanner entrada, int valorMinimo) {
        int numero;
        while (true) {
            ...
            try {
                ...
                if (numero >= valorMinimo) {
                    ...
                    System.out.println("Entrada invalida. Digite um numero maior ou igual a " + valorMinimo + ".");
                }
